...
public class CommandEvent extends PluginEvent {
	...
	public final String getCommandWithoutPrefix() {
		return this.getMessage().getRawContent().replaceFirst(this.prefix, "");
	}
	...
	/**
	 * Uploads a file to the Discord servers and sends it to this {@link net.dv8tion.jda.entities.TextChannel TextChannel}. Sends the provided
	...
	/**
	 * Asynchronously uploads a file to the Discord servers and sends it to this {@link net.dv8tion.jda.entities.TextChannel TextChannel}. Sends the provided
	 * {@link net.dv8tion.jda.entities.Message Message} with the uploaded file.<br>
	 * If you do not wish to send a Message with the uploaded file, you can provide <code>null</code> for the <code>message</code> parameter.
	 *
	 * @param file
	...
	/**
	 * Sends a given {@link net.dv8tion.jda.entities.Message Message} to this Channel This method only extracts the mentions, text and tts status out of the given Message-Object
	 * Therefore this can also be used to resend already received Messages To allow above behaviour, this method returns a new {@link net.dv8tion.jda.entities.Message Message}
	 * instance. The passed one is not modified! If the sending of the Message failed (probably Permissions), this method returns null. When the Rate-limit is reached (30 Messages
	 * in 30 secs), a {@link net.dv8tion.jda.exceptions.RateLimitedException RateLimitedException} is thrown
	 *
	 * @param msg
	...
	/**
	 * Sents a plain text {@link net.dv8tion.jda.entities.Message Message} to this channel. This will fail if the account of the api does not have the
	 * {@link net.dv8tion.jda.Permission#MESSAGE_WRITE Write-Permission} for this channel set After the Message has been sent, the created {@link net.dv8tion.jda.entities.Message
	 * Message} object is returned This Object will be null, if the sending failed. When the Rate-limit is reached (5 Messages in 5 secs), a
	...
	/**
	 * Sends a given {@link net.dv8tion.jda.entities.Message Message} to this Channel This method only extracts the mentions, text and tts status out of the given Message-Object
	 * Therefore this can also be used to resend already received Messages. To allow above behaviour, this method calls the callback with a new
	 * {@link net.dv8tion.jda.entities.Message Message} instance. The passed one is not modified! This method will wait, and send later, if a Rate-Limit occurs.
	 *
	 * @param msg
	 *            the {@link net.dv8tion.jda.entities.Message Message} to send
	 * @param callback
	...
	/**
	 * Sents a plain text {@link net.dv8tion.jda.entities.Message Message} to this channel. After the message has been sent, the corresponding
	 * {@link net.dv8tion.jda.entities.Message Message} object is passed to the callback-function This method will wait, and send later, if a Rate-Limit occurs.
	 *
	 * @param msg
	 *            the text to send
	 * @param callback
